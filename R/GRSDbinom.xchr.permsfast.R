#' @title Association mapping on the X chromosome with binary variable outcomes, optimized for speed by
...
GRSDbinom.xchr.permsfast = function(obj, pheno, pheno.col, addcovar, tx, sanger.dir = "~/Desktop/R/QTL/WD/HS.sanger.files/") {
        timechrx <- Sys.time()
        chr = obj$markers[1,2]
